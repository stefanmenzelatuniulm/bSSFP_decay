...
function [ftl,ftu]=plotM2Dfit(M,X,plotTitle,xLabel,subfolder)
    ...
    options=fitoptions('Method','NonlinearLeastSquares','Lower',[0 -10 -10 -10 -10 -10 0.001 0.001],'Upper',[1 10 10 10 10 10 10 10],'StartPoint',[0 1 1 0 0 0 0.6 0.6]);
    ...
    hold on;
    ftu=fit(transpose(X),M,fttype,options);
    plot(ax,ftu,"r");
